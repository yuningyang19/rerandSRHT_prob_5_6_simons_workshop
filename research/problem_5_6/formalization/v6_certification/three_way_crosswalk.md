...
The authoritative machine-readable counterpart is three_way_crosswalk.json. It preserves every frozen A/B/C source cell and records current actual-type/definition hashes without changing the 12/50/34 denominators.
